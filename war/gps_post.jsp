	  ...
	  int total = Datastore.getTotalDevices();
		if (total == 0) {
			out.print("<h2>No devices registered!</h2>");
			 ...
			 out.print("<form name='form' method='POST' action='sendAll'></br>");
			 out.print("latitude: <input type='text' name='latitude' ></br>");
			 out.print("longitude: <input type='text' name='longitude' ></br>");
