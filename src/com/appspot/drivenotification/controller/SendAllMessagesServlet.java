...
* \date 	11.2012
*
* \brief 	Servlet that adds a new message to all registered devices.
* \details 	
********************************************************************/
...
public class SendAllMessagesServlet extends BaseServlet {
  ...
  /**
   * \brief Processes the request to add a new message.
   * Decide simple post or multicast depends on device number.
   */
  @Override
  protected void doPost(HttpServletRequest req, HttpServletResponse resp)
    ...
    String message = req.getParameter("message");//home.jspÇÃÉtÉHÅ[ÉÄÇ≈ì¸óÕÇµÇΩï∂éöóÒ
